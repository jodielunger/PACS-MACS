...
Requirements: 
1. `phago_suma_combined.Rds` This is the only dataset required to run the two-state model and must be downloaded from Zenodo [10.5281/zenodo.19699424](10.5281/zenodo.19699424). During peer review, this dataset will be restricted for reviewer access only.
